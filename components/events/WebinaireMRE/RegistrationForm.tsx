    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center max-w-xl mx-auto">
        ...
        <p className="text-green-700 text-sm mb-3">
          Le lien de connexion vous sera envoyé par email avant le webinaire.
        </p>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 max-w-xl mx-auto">
      ...
      <p className="text-gray-500 text-sm mb-8">
        Gratuit · Le lien de connexion vous sera envoyé par email
      </p>
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-5">
        ...
        <div className="space-y-2">
          <p className="text-sm font-medium text-gray-700">
            Souhaitez-vous être contacté(e) par Génération Diaspora pour les futurs événements ?
          </p>
