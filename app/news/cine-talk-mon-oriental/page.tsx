...
import HeroSection from "@/components/events/CineTalkMonOriental/HeroSection";
import EventDetails from "@/components/events/CineTalkMonOriental/EventDetails";
import AboutFilm from "@/components/events/CineTalkMonOriental/AboutFilm";
import RegistrationForm from "@/components/events/CineTalkMonOriental/RegistrationForm";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/events/cine-talk-mon-oriental/poster.webp",
        width: 320,
        height: 460,
...
export default function CineTalkMonOrientalPage() {
  return (
    <div className="bg-beige">
      ...
      {/* 2. Détails */}
      <EventDetails registrationUrl="[INSCRIPTION_URL]" />
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto flex flex-col items-center gap-6 text-center">
            {/* Logo */}
            <div className="w-16 h-16 bg-beige rounded-xl p-2 flex items-center justify-center">
              <Image
                src="/logo.png"
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                ...
                className="flex items-center gap-1.5 bg-primary-600 hover:bg-primary-700 text-white text-xs font-semibold px-3 py-2 rounded-full transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center gap-1.5 bg-gold-600 hover:bg-gold-700 text-white text-xs font-semibold px-3 py-2 rounded-full transition-colors"
              >
